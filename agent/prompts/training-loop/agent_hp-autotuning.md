...
FROZEN PARAMETERS — DO NOT MODIFY UNDER ANY CIRCUMSTANCES

Read agent/doc/parameter_constraints.json and check the "frozen" section.
Any parameter listed there must NEVER appear in tuning_decision regardless of its current value.

Omit frozen parameters entirely from your output.
These are hardware/throughput constraints, not tuning targets."